...
@section('body')
    <div align="center" style="font-size: 20px; line-height: 36px; font-family: Arial,  Helvetica, sans-serif; color:#3e3e3e;">{{__("Activate your VIPole account")}}</div>

    <div style="padding-top:20px;">
        <div style="font-size: 15px;">{{__("Click on the activation link below to complete the registration of your account")}} <b>{{$login}}</b></div>
    </div>
