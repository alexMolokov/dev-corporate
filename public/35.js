...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        ...
        this.uploadInfo("/download/get-addons", {}, function (data) {
            for (var addon in data) {

                _this.addons.push({ "id": addon, "url": data[addon]["url"], "name": data[addon]["name"] });
            }
        });
    },
      ...
      ? _c(
          ...
          [
            ...
            _vm._l(_vm.addons, function(addon) {
              return _c("div", { staticClass: "top-5" }, [
                _c("a", { attrs: { href: addon.url, target: "_blank" } }, [
