                  ...
                  _c("div", { staticClass: "input-group" }, [
                    _vm.type_input_current === "checkbox"
                      ? _c("input", {
                          ...
                          class: { error: _vm.errors.has("old_password") },
                          attrs: { name: "old_password", type: "checkbox" },
                          domProps: {
                            checked: Array.isArray(_vm.old_password)
                              ? _vm._i(_vm.old_password, null) > -1
                              : _vm.old_password
                          },
                          on: {
                            change: function($event) {
                              var $$a = _vm.old_password,
                                $$el = $event.target,
                      ...
                      : _vm.type_input_current === "radio"
                        ? _c("input", {
                            ...
                            staticClass: "form-control",
                            class: { error: _vm.errors.has("old_password") },
                            attrs: { name: "old_password", type: "radio" },
                            domProps: {
                              checked: _vm._q(_vm.old_password, null)
                            },
                            on: {
                              change: function($event) {
                                _vm.old_password = null
                              }
                            }
                          })
                        : _c("input", {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__states__ = __webpack_require__(93);
//
//
//
//
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__modalWindow_vue__ = __webpack_require__(101);
...
var ajaxform = __webpack_require__(62);
var errorInform = __webpack_require__(90);
var loadingInform = __webpack_require__(97);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        clean: function clean() {
            this.password = '', this.old_password = '', this.check_password = '';
